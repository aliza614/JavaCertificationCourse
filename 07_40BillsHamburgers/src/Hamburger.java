...
public class Hamburger {
    ...
    public double itemizeHamburger() {
        System.out.println(this.name+" hamburger on a "+this.breadRollType+" with "+meat+", price is "+price);
        ...
        System.out.println("Total Burger price is"+(price +addition1Price+addition2Price+addition3Price+addition4Price));
